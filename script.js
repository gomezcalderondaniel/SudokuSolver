    ...
    validateMatrix: function () {
      ...
      for (var row = 0; row < 9; row++) {
        for (var col = 0; col < 9; col++) {
          ...
          this.$cellMatrix[row][col].toggleClass(
            "sudoku-input-error",
            !isValid
          );
          if (!isValid) {
